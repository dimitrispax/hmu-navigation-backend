...
const warnFilter = winston.format((info: any, opts: any) => {
    return info.level === 'warn' ? info : false;
});

const infoFilter = winston.format((info: any, opts: any) => {
    return info.level === 'info' ? info : false;
});

const httpFilter = winston.format((info: any, opts: any) => {
    return info.level === 'http' ? info : false;
});

const verboseFilter = winston.format((info: any, opts: any) => {
    return info.level === 'verbose' ? info : false;
});

const debugFilter = winston.format((info: any, opts: any) => {
    return info.level === 'debug' ? info : false;
});

const sillyFilter = winston.format((info: any, opts: any) => {
    return info.level === 'silly' ? info : false;
});

class WinstonLoggingHandler implements ILogger {
